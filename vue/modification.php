...
<div class="login-logo">
    <b>Modification de A et B</b>
  </div>
<div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Entrer A et B</p>

      <form action="../controller/cerveauModif.php" method="post">
        <div class="input-group mb-3">
        <?php
          echo "<input required type=\"number\" name=\"a\" value=\"$a\" class=\"form-control\" >";
            ?>
        ...
        <div class="input-group mb-3">
            <?php
          echo "<input required type=\"number\" name=\"b\" value=\"$b\" class=\"form-control\" >";
            ?>
          <div class="input-group-append">
            <div class="input-group-text">
